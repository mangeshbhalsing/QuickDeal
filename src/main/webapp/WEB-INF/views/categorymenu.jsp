    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
         ...
         <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>Login/Register<span class="caret"></span></a>
          <ul class="dropdown-menu">
          <c:if test="${empty loginMessage}">
            <li><a href="login"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>Login/Register</a></li>
            </c:if>
