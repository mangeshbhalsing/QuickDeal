	...
	<div class="col-md-4">
		...
		<c:forEach items="${cartList}" var="cart">
			<ul class="widget-products">
				<li><span class="product clearfix"> <span class="name">
							${cart.product_name}&nbsp; &nbsp; &nbsp; &nbsp; <a
							href="<c:url value='/manage_cart_delete/${cart.id}'/>">delete
						</a>
					</span> <span class="price"> <i class="fa fa-money"></i>${cart.price}
					</span>
				</span> </a></li>
