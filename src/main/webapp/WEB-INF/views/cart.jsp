...
<ul class="widget-products">
                  <li>
                     ...
                     <span class="name">
                     ${cart.product_name}&nbsp; &nbsp; &nbsp; &nbsp;
                      <a href="<c:url value='/manage_cart_delete/${cart.id}'/>">delete </a>
                     </span>
                     <span class="price">
                     <i class="fa fa-money"></i>${cart.price}
                     </span>
                     </span>
                     </a>
                  </li>
...
<center><h3>Total Amount ${Total}</h3></center>
<center><a class="btn btn-success" href="checkout">Check out</a></center>
<br/>
<br/>
